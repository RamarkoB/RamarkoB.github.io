...
function randomExcuse(){
    const excuses = ["a break in the space-time continuum", "a murder mystery gone horribly wrong", 
    ...
    "technical difficulties", "human error", "traffic on the route 99", "an advanced screening of Jordan Peele's next movie", 
    "a scenario where I have to pretend to be at two events at once", "accidental invovlement as the enwisened side charecter in a Rom-Com",
    "a tragic case of an ill timed IBS attack", "Jury Duty", "a horrible misunderstanding of the definition of 'suffrage'", 
    "a flare-up of antidisestablishmentarianism", "the fourth defenestration of Prague", "speaking truth to power",
